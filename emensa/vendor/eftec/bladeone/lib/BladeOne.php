...
class BladeOne
{
    ...
    public static function startsWith($haystack, $needles): bool
    {
        foreach ((array)$needles as $needle) {
            if ($needle != '') {
                ...
                } else if ($haystack !== null && \strpos($haystack, $needle) === 0) {
                    return true;
                }
            }
        }
    ...
    public function renderEach($view, $data, $iterator, $empty = 'raw|'): string
    {
        ...
        } else if (static::startsWith($empty, 'raw|')) {
    ...
    protected function pipeDream($result): string
    {
        ...
        for ($i = 1; $i <= $c; $i++) {
            ...
            } else if (isset($this->customDirectives[$fnName])) {
                $fnName = '$this->customDirectives[\'' . $fnName . '\']';
            } else if (method_exists($this, $fnName)) {
                $fnName = '$this->' . $fnName;
            }
